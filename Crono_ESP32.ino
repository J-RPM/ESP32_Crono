...
bool Mode_CRONO = false;
bool Cambio = false;
bool Crono = false;
const int pinPulsa = 14;                                  // Pin GPIO donde está conectado el pulsador
int Conta = 0;
int Minuto = 0;
int Segundo = 0;
int Decima = 0;
...
void setup(){
  ...
  timerAlarmWrite(timer, 100000, true);                   // Interrupción cada 0,1 segundo
...
void matrix_crono() {
  dx=dy=0;
  clr();
  showDigit(Minuto/10,  2, dig4x8r);
  showDigit(Minuto%10,  7, dig4x8r);
  showDigit(Segundo/10, 14, dig4x8r);
  showDigit(Segundo%10, 19, dig4x8r);
  showDigit(Decima%10, 26, dig4x8r);
  setCol(12,1 ? B00100100 : 0);
  setCol(24,1 ? B10000000 : 0);
  refreshAll();
}
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
